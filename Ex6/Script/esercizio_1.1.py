...
feat_brick = extract_feature(brick)
feat_grass = extract_feature(grass)
feat_gravel = extract_feature(gravel)

confronto = ml.leggiJPG("img2.jpg")
feat_confronto = extract_feature(confronto)
